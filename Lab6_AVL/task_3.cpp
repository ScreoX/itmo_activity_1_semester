...
struct AVL_Tree {
    ...
    void insert_for_new_element(int x) {
        root = _insert_for_new_element(x, root);
    }
...
int main() {
    ...
    int new_element; cin >> new_element;

    avlchik_tree.insert_for_new_element(new_element);

    avlchik_tree.print(n + 1);
